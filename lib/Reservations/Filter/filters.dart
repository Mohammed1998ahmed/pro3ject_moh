                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width * .0410,
                            ),
                            ChoiceChip(
                      ...
                      child: Row(
                          ...
                          children: [
                            text(
                              title: "Most Popular",
                              fontSize: 18,
                              color: selectSort == "s1" ? Color0 : Colors.black,
                            ),
                            selectSort == "s1"
                                ? Icon(
                                    Icons.done,
                      ...
                      child: Row(
                          ...
                          children: [
                            text(
                              ...
                              fontSize: 18,
                              color: selectSort == "s3" ? Color0 : Colors.black,
                            ),
                            selectSort == "s3"
                                ? Icon(
                                    Icons.done,
                      ...
                      child: Row(
                          ...
                          children: [
                            text(
                                ...
                                fontSize: 18,
                                color:
                                    selectSort == "s2" ? Color0 : Colors.black),
                            selectSort == "s2"
                                ? Icon(
                                    Icons.done,
                                    color: Color0,
                            ...
                            children: [
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      Border.all(color: LinearGradientColor03),
                                  boxShadow: [
                                    BoxShadow(
                                      color: p1
                                ...
                                child: ClipOval(
                                  child: Material(
                                    color: p1 ? Color0 : LinearGradientColor03,
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          p1 = !p1;
                              ...
                              Container(
                                ...
                                child: ClipOval(
                                  child: Material(
                                    color: p2 ? Color0 : LinearGradientColor03,
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          p2 = !p2;
                              ...
                              Container(
                                ...
                                child: ClipOval(
                                  child: Material(
                                    color: p3 ? Color0 : LinearGradientColor03,
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          p3 = !p3;
