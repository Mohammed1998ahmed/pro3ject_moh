...
class ReviewTriner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(trainer_id.toString() + "LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
    return BlocProvider(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            cubit.userHasReviewInTrainer == null
                                                ? Container()
                                                : cubit.userHasReviewInTrainer!
                                                            .status ==
                                                        true
                                                    ? state
                                                            is TrinnerUpdataReviewLoading
                                                        ? Center(
                                                            child:
                                                                SpinkitWave())
                                                        : GestureDetector(
                        ...
                        Row(
                          children: [
                            ...
                            cubit.getAllReviewUserByTrinner != null
                                ? text(
                                    title: cubit.getAllReviewUserByTrinner!
                                                .reviews ==
                                            null
                                        ? "(0)"
                                        : "(" +
                                            cubit.getAllReviewUserByTrinner!
                                                .reviews!.length
                                                .toString() +
                                            ")",
                                    fontSize: 15,
                        ...
                        cubit.getAllReviewUserByTrinner == null
                            ...
                            : Container(
                                ...
                                child: ListView.separated(
                                  // shrinkWrap: false,
                                  itemCount: cubit.getAllReviewUserByTrinner!
                                              .reviews ==
                                          null
                                      ? 0
                                      : cubit.getAllReviewUserByTrinner!
